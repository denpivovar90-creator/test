...
Чтобы заменить фото в слайдере — просто положи новые файлы с теми же именами (slide1/2/3.jpg) в корень репозитория, либо поменяй пути в `index.html` в блоке `<section class="hero">`.
